        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 h-[450px] bg-white">
                ...
                <div className="hidden md:flex flex-col items-center text-xl pt-20 px-10">
                    ...
                    <button onClick={() => {alert("You have claimed your discount!")}} className="p-3 mt-16 font-extralight text-white bg-green-700 rounded-full animate-bounce">Claim Discount</button>
                </div>
            </div>
